...
export const NodesSchema = z.object({
    ...
    machineUuid: z.uuid().nullable(),
    endpointUuid: z.uuid(),
    protocolKey: z.string().nullable(),
    lifecycleState: z.string(),
    isPublished: z.boolean(),
    externalPort: z.int().nullable(),
    externalNetwork: z.enum(['tcp', 'udp']).nullable(),
    protocolSettings: z.record(z.string(), z.unknown()),
    desiredRevision: z.int().nonnegative(),
    appliedRevision: z.int().nonnegative(),
    certificateMode: z.enum(['HTTP_01', 'IMPORT_EXISTING']).nullable(),
    certificateStatus: z.enum([
        'NOT_REQUIRED',
        'PENDING',
        'ISSUING',
        'VALID',
    ...
    certificateExpiresAt: z.nullable(z.iso.datetime().transform((str) => new Date(str))),
    ...
    lastErrorCode: z.nullable(z.string()),
